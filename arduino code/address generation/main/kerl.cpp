...
void kerl_absorb_bytes(cx_sha3_t *sha3, signed char *bytes,
                       unsigned int len)
{
    cx_hash((cx_hash_t *)sha3, 0, (signed char *)bytes, len, NULL);
}
...
void kerl_squeeze_chunk(cx_sha3_t *sha3, signed char *bytes_out)
{
    signed char state_bytes[NUM_HASH_BYTES];
...
static inline void flip_hash_bytes(signed char *bytes)
{
...
void kerl_state_squeeze_chunk(cx_sha3_t *sha3, signed char *state_bytes,
                              signed char *bytes_out)
{
