 ...
 */
void chars_to_trits(char *chars, trit_t *trits, unsigned int chars_len);
int chars_to_trytes(const char *chars, trit_t *trits, unsigned int chars_len);
int trytes_to_trits(const tryte_t trytes_in[], trit_t trits_out[], unsigned int tryte_len);
int trits_to_trytes(const trit_t trits_in[], tryte_t trytes_out[], unsigned int trit_len);
int trytes_to_chars(const tryte_t trytes_in[], char chars_out[], unsigned int len);
 ...
 */
void trits_to_bytes(signed char *trits, signed char *bytes);
 ...
 */
void chars_to_bytes( char *chars, signed char *bytes, unsigned int chars_len);
 ...
 */
void bytes_to_chars(signed char *bytes, char *chars, int bytes_len);
 ...
 */
void bytes_set_last_trit_zero(signed char *bytes);
 ...
 */
void bytes_add_u32_mem(signed char *bytes, uint32_t summand);
