...
const vote = async () => {
    ...
    eventrating = 5; // rating wordt uit de app gehaald
    //eventrating = rating;
    timestamp = 'timestamp' //Timestamp in unix-tijd

    var mamStateVisitor = JSON.parse('{"subscribed":[],"channel":{"side_key":null,"mode":"public","next_root":"FODDHV9FRQMFCOPOETOWFUNJYCVQVFUVJILQBCTNFDZXBUIFFTDCQYKKPQXPGAKIHT9SIXAGJRHBFYAQF","security":2,"start":1,"count":1,"next_count":1,"index":0},"seed":"AVEGUQJTV9ZWNVVRRVTVKERVUPWFJNLXVAO9NZIPIYFUOSUC9IFONSJCQPCXJYOLR9LYS9ALTILXAMYMJ"}') //Voorbeeldgebruiker voor 1000 aantal dagen
    //var mamStateVisitor = JSON.parse(tmpfile.getFromTmpFile('visitor.state')) visitor.state opgeslagen op bezoekersapp
    ...
    var voteref = message.root //Niet nodig
}
